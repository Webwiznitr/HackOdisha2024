    ...
    <div>
      <div className="body bg-[#604151] flex justify-center overflow-hidden">
        ...
        <div className="parentBox flex justify-center flex-row-reverse">
          <div className="UpperRightLogo absolute ml-72 mt-24 sm:-mr-72 lg:mr-[-40rem] lg:mt-36"><img src={UpperRightLogo} alt="re-render" className='pl-4 lg:h-12'/></div>
...
<div className="box2 ml-20 sm:flex mt-4 lg:mt-12">
        ...
        <div className="LowerLeftLogo absolute mt-[658px] mr-72 sm:mt-[32rem] sm:mr-[36rem] lg:mt-[43rem] lg:mr-[62rem]"><img src={LowerLeftLogo} alt="re-render" className=' lg:h-12'/></div>
        </div>
