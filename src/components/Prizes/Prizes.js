                        ...
                        <div className="card1 h-36 w-60 bg-[#FFF6E0] mt-14 rounded-[6.54px] hover:scale-105 transition ml-20 sm:ml-56 lg:h-48 lg:w-80 lg:ml-80 lg:mt-28">
                            <div className="Frame2">
                                <img
                                    src={Frame2}
                                    alt="no-render"
                                    className="absolute z-40 h-24 w-24 mt-[-30px] ml-[-34px] lg:h-32 lg:w-32 lg:ml-[-46px] lg:mt-[-40px]"
                                />
                            ...
                            <div className="cardBody mt-2 h-28 w-60 bg-[#FFF6E0] rounded-[6.54px] relative z-20 flex items-center flex-col lg:h-36 lg:w-80 lg:mt-4">
                                <div className="star1 self-start">
                                    <img
                                        src={star1}
                                        alt="no-render"
                                        className="absolute mt-7 ml-3 h-5 lg:h-7"
                                    />
                                </div>
                                <div className="MainContent font-dela-gothic text-[#FFCA04] text-stroke-outline text-4xl lg:text-[52px]">
                                    Gold <br />
                                </div>
                                <div className="MainContent2 font-dela-gothic text-[#F98C3A] text-sm pt-2 lg:text-lg lg:ml-5 lg:mt-2">
                        ...
                        <div className="box2 ml-20 sm:flex mt-4 lg:mt-12">
                            <div className="card2 h-36 w-60 bg-[#FFF6E0] mt-10 rounded-[6.54px] hover:scale-105 transition sm: mr-16 lg:h-48 lg:w-80 lg:mr-24">
                                ...
                                <div className="cardBody mt-2 h-28 w-60 bg-[#FFF6E0] rounded-[6.54px] relative z-20 flex items-center flex-col lg:h-36 lg:w-80 lg:mt-4">
                                    ...
                                    <div className="MainContent font-dela-gothic text-[#FFCA04] text-stroke-outline text-3xl lg:text-[50px]">
                                        Silver
                                        <br />
                                    </div>
                                    <div className="MainContent2 font-dela-gothic text-[#F98C3A] text-sm pt-2 lg:text-lg lg:ml-5 lg:mt-2">
                            ...
                            <div className="card3 h-36 w-60 bg-[#FFF6E0] mt-10 mb-20 rounded-[6.54px] hover:scale-105 transition sm: mr-16 lg:h-48 lg:w-80 lg:ml-24 lg:mb-28">
                                ...
                                <div className="cardBody mt-2 h-28 w-60 bg-[#FFF6E0] rounded-[6.54px] relative z-20 flex items-center flex-col lg:h-36 lg:w-80 lg:mt-4">
                                    ...
                                    <div className="MainContent font-dela-gothic text-[#FFCA04] text-stroke-outline text-3xl lg:text-[49px] lg:ml-4">
                                        Bronze <br />
                                    </div>
                                    <div className="MainContent2 font-dela-gothic text-[#F98C3A] text-sm pt-2 lg:text-lg lg:ml-5 lg:mt-2">
                                        Goodies and T-Shirts <br />
