...
const AreUReady = () => {
  return (
    <section className='bg-[#634752] relative'>
      <div className='flex flex-col items-center justify-center py-[6rem] md:py-[6rem] lg:py-[8rem]'>
      <video
      ...
      preload='none'
      disablePictureInPicture
      className='absolute sm:left-5 sm:bottom-6 bottom-2 left-4 sm:block sm:w-[6rem] md:w-[8.5rem] lg:pb-10 lg:ml-20'
      >
      </video>
      </div>
    </section>
