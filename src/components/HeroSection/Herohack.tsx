    ...
    return (
        <div>
            ...
            <div className="flex justify-center items-center 2xl:mt-20 xl:mt-12 lg:mt-10 md:mt-8 sm:mt-12 mt-8 relative ">
                <button
                    type="button"
                    className="md:rounded-[18px] sm:rounded-[13px] rounded-[10px] text-xl sm:text-3xl md:text-3xl 2xl:text-5xl xl:text-4xl font-medium border-solid border-opacity-70 md:px-[20px] md:py-[10px] lg:px-[30px] lg:py-[15px] py-[5px] px-[10px] text-center me-2 mb-2 bg-[#E16C00] text-white font-oxanium hover:bg-[#a7552f] "
                    style={{
