...
const Herohack = () => {
    return (
        <div>
            <div className="text-[rgb(208,52,65)] h-full w-full text-[3.8rem] tracking-[0.5rem] sm:tracking-[1.2rem] lg:tracking-[0.15] sm:text-8xl md:text-9xl lg:text-[150px] xl:text-[180px] 2xl:text-[210px] lg:text-8xl font-bold leading-7 font-brandon  shadow border-none">
                HACKODISHA
            </div>
            <div className="text-[#D03441] h-full w-full text-[0.8rem] sm:text-2xl md:text-2xl lg:text-3xl text-center font-bold font-ARP 2xl:mt-8 xl:mt-8 lg:mt-8 md:mt-8 sm:mt-12 mt-8">
                6th - 7th September
            </div>
            <div className="flex justify-center items-center mt-10 relative ">
                <button
                    ...
                    onClick={() => {
                        location.href =
                            "https://drive.google.com/file/d/1gTEDKWynKmF99o43omasDbHctoNn5TeZ/view";
                    }}
                    onMouseDown={(e) => {
